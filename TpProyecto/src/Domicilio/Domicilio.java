...
public abstract class Domicilio implements Cloneable {
	...
	/**
	 * Este metodo nos ayuda a asegurar que nuestro domicilio no se ingrese en otra lista de domicilios/contrataciones.<br><br>
	 * <b>Pre</b>:<br> 
	 * <b>Inv</b>:<br> 
	 ...
	 * <b>Pre</b>:<br>
	 * <b>Inv</b>:<br>
	 * <b>Post</b>: retorna el descuento de la promoDorada dependiendo su tipo de domicilio.<br>
	 */
	public abstract double promoDorada();
	/**
	 * <b>Pre</b>:<br>
	 * <b>Inv</b>:<br>
	 * <b>Post</b>: retorna el descuento de la promoPlatino dependiendo su tipo de domicilio.<br>
	 */
